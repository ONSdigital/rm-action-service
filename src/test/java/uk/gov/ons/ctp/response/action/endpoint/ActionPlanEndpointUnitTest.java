...
public class ActionPlanEndpointUnitTest {
  ...
  private static final UUID NON_EXISTING_ACTION_PLAN_ID =
      UUID.fromString("e71002ac-3575-47eb-b87f-cd9db92bf9a1");
  private static final UUID ACTION_PLAN_1_ID =
      UUID.fromString("e71002ac-3575-47eb-b87f-cd9db92bf9a7");
  private static final UUID ACTION_PLAN_2_ID =
  ...
  public void setUp() throws Exception {
    ...
    this.mockMvc =
        MockMvcBuilders.standaloneSetup(actionPlanEndpoint)
  ...
  public void findActionPlansUnCheckedException() throws Exception {
    when(actionPlanService.findActionPlans())
  ...
  public void updateActionPlan() throws Exception {
    ...
    final ResultActions actions =
        mockMvc.perform(
            putJson(String.format("/actionplans/%s", ACTION_PLAN_1_ID), ACTION_PLAN_JSON));
  ...
  public void createActionNameExists() throws Exception {
    ...
    resultActions
        ...
        .andExpect(handler().methodName("createActionPlan"))
        .andExpect(
            jsonPath("$.error.code", is(CTPException.Fault.RESOURCE_VERSION_CONFLICT.name())))
        .andExpect(
            jsonPath(
                "$.error.message",
  ...
  public void createActionPlanInvalidJsonProvided() throws Exception {
    ResultActions resultActions =
        mockMvc.perform(postJson("/actionplans", ACTION_PLAN_INCORRECT_JSON));
