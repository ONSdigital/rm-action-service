...
public class ActionCaseRepositoryTest {
  ...
  @Autowired private ActionTypeRepository actionTypeRepository;
  ...
  public void testWithAnActionPlanJobButActionPlansNotStartedDoNothing() {
    ...
    //// When
    boolean actual = actionService.createScheduledActions(actionPlanJob.getActionPlanJobPK());
  ...
  public void testActiveActionPlanJobAndActionPlanCreatesAction() {
    ...
    assertEquals(
        actionType.getActionTypePK(), createdActions.get(0).getActionType().getActionTypePK());
