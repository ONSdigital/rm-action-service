...
public interface CaseSvcClientService {
  ...
  /**
   * Call CaseSvc using REST to get the CaseGroups details MAY throw a RuntimeException if the call
   * fails
   *
  ...
  /**
   * Call CaseSvc using REST to get the Case details MAY throw a RuntimeException if the call fails
   *
  ...
  /**
   * Call CaseSvc using REST to get the CaseEvents for the Case MAY throw a RuntimeException if the
   * call fails
   *
